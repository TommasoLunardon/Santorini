...
class PlayerPanTest {
    ...
    @Test
    void move1() throws InvalidIndicesException, InvalidBoxException, NotValidLevelException, InvalidMovementException {
    ...
    @Test
    void move2() throws InvalidIndicesException, InvalidBoxException, InvalidMovementException {
        Box box1 = map.getBox(0,0);
        Box box2 = map.getBox(0,1);
