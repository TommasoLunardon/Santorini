...
class PlayerAthenaTest {
    ...
    @Test
    void move1() throws InvalidIndicesException, NotValidLevelException, InvalidBoxException, InvalidMovementException, AthenaConditionException {
    ...
    @Test
    void move2() throws InvalidBoxException, NotValidLevelException, InvalidIndicesException, InvalidMovementException, AthenaConditionException {
        ArrayList<PlayerNotAthena> observer = new ArrayList<PlayerNotAthena>();
        PlayerNotAthena player1 = new PlayerPan("a", 13, PlayerColor.YELLOW, map);
        PlayerNotAthena player2 = new PlayerApollo("a", 13, PlayerColor.YELLOW, map);
