...
class PlayerArthemisTest {
    ...
    @Test
    void moveArthemis1() throws InvalidIndicesException, InvalidBoxException, WrongMovementException {
    ...
    @Test
    void moveArthemis2() throws InvalidIndicesException, InvalidBoxException {
        ...
        try{player.moveArthemis(box2, box3, player.getWorkers().get(0));}catch(WrongMovementException e){
