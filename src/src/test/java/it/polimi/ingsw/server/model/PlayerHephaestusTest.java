...
class PlayerHephaestusTest {
    ...
    @Test
    void buildEphaestus_correct() throws InvalidIndicesException, InvalidBoxException, NotValidLevelException, WrongConstructionException {
    ...
    @Test
    void buildEphaestus_wrong_Dome() throws InvalidIndicesException, InvalidBoxException, NotValidLevelException {
        Box box1= map.getBox(0,0);
        Box box2 =map.getBox(0,1);
        box2.setLevel(2);
